      ...
      <section className="space-y-3">
        ...
        <div className="space-y-2.5">
          {foodItems.map(dish => (
            <div
              key={dish.id}
              className="bg-white p-3 rounded-xl border border-gray-100 shadow-sm flex items-center gap-3.5"
            >
              <div className="w-10 h-10 rounded-lg bg-gray-50 border border-gray-105 overflow-hidden flex-shrink-0">
              ...
              <button
                ...
                className="w-8 h-8 rounded-full flex items-center justify-center text-rose-500 hover:bg-rose-50 border border-transparent hover:border-rose-150 transition-colors cursor-pointer shrink-0"
              >
